    ...
    foreach ($result as $row)
    {
      ...
      /* Editing of a booking in the database */
       if (isset($_POST[$modif]))
       {
            ...
            $result = db::selectRow($mysql,'reservations',$id); 
        ...
        {
          db::removeReservation($mysql,'reservations',$id);
        ...
        /* Default page */
        elseif (empty($_POST['addReservation']) && !isset($_POST[$delete]) && !isset($_POST[$modif]) && !isset($delete) && !isset($modif))
        {
          include "../views/bookingslist.php";
        }
